...
$env.POSH_THEME = (echo "C:\\Users\\kobbi\\jandedobbeleer.omp.json")
$env.PROMPT_INDICATOR = ""
$env.POSH_SESSION_ID = (echo "e7c636aa-7e18-4389-bfc3-3c553c5fda6d")
$env.POSH_SHELL = "nu"
$env.POSH_SHELL_VERSION = (version | get version)

let _omp_executable: string = (echo "C:/Users/kobbi/AppData/Local/Programs/oh-my-posh/bin/oh-my-posh.exe")
