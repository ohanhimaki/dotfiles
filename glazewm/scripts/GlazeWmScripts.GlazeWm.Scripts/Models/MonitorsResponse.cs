...
namespace GlazeWmScripts.GlazeWm.Scripts.Models
{
    ...
    public class Workspace
    {
        ...
        public System.Collections.Generic.ICollection<Window> Children { get; set; }
    ...
    public class Monitor
    {
        ...
        [JsonPropertyName("children")]
        public ICollection<Workspace> Children { get; set; }

        [JsonPropertyName("childFocusOrder")]
        public ICollection<string> ChildFocusOrder { get; set; }
